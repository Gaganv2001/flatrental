  ...
  return (
    <div className='mt-3 ml-3 mr-3 bs'>
        ...
        <Tabs defaultActiveKey='1'>
            ...
            <TabPane tab="Flats" key={"2"}>
                <Rooms/>
            </TabPane>
            <TabPane tab="Add Flat" key={"3"}>
                <Addroom />
            </TabPane>
...
export  function Addroom() {
    ...
    async function addRoom() {
        ...
        try {
            ...
            console.log(result)
            setloading(false)
            Swal.fire('Done' , "New Flat Added Successfully" , 'success').then(result=>{
                window.location.href='/home'
            })
        } catch (error) {
            console.log(error)
  ...
  return (
    <div className='row'>
        ...
        <div className='col-md-5'>
            ...
            <input type="text" className='form-control' placeholder='Flat Name' value={name} onChange={(e)=>{setname(e.target.value)}}/>
            <input type="text" className='form-control' placeholder='Price' value={rentpermonth} onChange={(e)=>{setrentpermonth(e.target.value)}}/>
            <input type="text" className='form-control' placeholder='Number of rooms' value={maxcount} onChange={(e)=>{setmaxcount(e.target.value)}}/>
            <input type="text" className='form-control' placeholder='Address' value={description} onChange={(e)=>{setdescription(e.target.value)}}/>
        ...
        <div className='col-md-5'>
            ...
            <input type="text" className='form-control' placeholder='Description' value={type} onChange={(e)=>{settype(e.target.value)}}/>
            ...
            <div className='text-right'>
                ...
                <button className='btn btn-primary mt-2' onClick={addRoom}>Add Flat</button>
